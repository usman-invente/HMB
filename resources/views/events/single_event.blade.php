          ...
          <div class="blog-posts">
            <div class="post">
              <div class="post-content">
                <figure class="main"> <img src="{{asset($event->thumbnail)}}" alt="" /></figure>
                <div class="meta"><span class="date">{{date('d M Y',strtotime($event->created_at))}}</span><span class="category"><a href="#" class="label label-info" style="color:white">Start date : {{date('d M Y',strtotime($event->start_date))}}</a>,<a href="#" class="label label-info" style="color:white">End date : {{date('d M Y',strtotime($event->end_date))}}</a></span></div>
                {!!$event->description!!}
