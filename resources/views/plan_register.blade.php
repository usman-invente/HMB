        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card" style="margin:64px">
                    ...
                    <div class="card-body">
                     @if (session('coupon'))
                             <p class="alert alert-danger">{{ session('coupon') }}</p>
                    @endif

                        <form role="form" method="POST" action="{{ route('pay.stripe') }}"
                            ...
                            <div class="form-group row">
                              ...
                              @if($countusers<=10)
                                <div class="form-group row">
                                    <label for="cvc" class="col-md-4 col-form-label text-md-right">Coupon</label>
