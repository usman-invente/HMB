                            ...
                            <div class="col-sm-6 col-md-4 event-grid-view-post" style="margin-bottom:50px;">
                                <div class="event-post">
                                    ...
                                    <div class="box ">
                                        ...
                                        <a href="{{route('single.offer',$offer->slug)}}" class="btn">Details</a>
                                        <a href="{{route('edit.offer',$offer->id)}}" class="btn">Edit</a>
                                        <a href="{{route('delete.offer',$offer->id)}}" class="btn">Delete</a>
                                    </div>
                                    <!-- /.box -->
