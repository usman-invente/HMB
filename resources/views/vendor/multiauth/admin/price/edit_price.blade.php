                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <form action="{{ route('admin.edit.price') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="1-5" class="form-control"
                                            value="{{$price->company_size }}" id="exampleInputEmail1" name="company_size">
                                        @error('company_size')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" value="{{$price->price }}""
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" value="{{$price->annual_price }}"
                                     ...
                                     <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{$price->monthly_plan_id}}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{$price->yearly_plan_id}}"
